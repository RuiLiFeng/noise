...
metric_defaults = EasyDict([(args.name, args) for args in [
    ...
    EasyDict(name='cond_wmax',  func_name='metrics.conditional_number.CondN',     num_samples=5000, epsilon=1e-2, space='w', report_type='max', crop=True, minibatch_per_gpu=4, Gs_overrides=dict(dtype='float32', mapping_dtype='float32')),
