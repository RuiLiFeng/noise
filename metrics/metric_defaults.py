...
metric_defaults = EasyDict([(args.name, args) for args in [
    ...
    EasyDict(name='cond_wmax',  func_name='metrics.perceptual_path_length.conditional_number',     num_samples=5000, epsilon=1e-4, space='w', report_type='max', crop=True, minibatch_per_gpu=4, Gs_overrides=dict(dtype='float32', mapping_dtype='float32')),
    EasyDict(name='cond_zmax',  func_name='metrics.perceptual_path_length.conditional_number',     num_samples=50000, epsilon=1e-4, space='z', report_type='max', crop=True, minibatch_per_gpu=4, Gs_overrides=dict(dtype='float32', mapping_dtype='float32')),
    EasyDict(name='cond_wmean',  func_name='metrics.perceptual_path_length.conditional_number',     num_samples=50000, epsilon=1e-4, space='w', report_type='mean', crop=True, minibatch_per_gpu=4, Gs_overrides=dict(dtype='float32', mapping_dtype='float32')),
    EasyDict(name='cond_zmean',  func_name='metrics.perceptual_path_length.conditional_number',     num_samples=50000, epsilon=1e-4, space='z', report_type='mean', crop=True, minibatch_per_gpu=4, Gs_overrides=dict(dtype='float32', mapping_dtype='float32')),
]])
