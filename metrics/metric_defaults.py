...
metric_defaults = EasyDict([(args.name, args) for args in [
    ...
    EasyDict(name='cond_wcrop',  func_name='metrics.conditional_number.CondN',     num_samples=50000, epsilon=1e-4, space='w', report_type='max', crop=True, minibatch_per_gpu=4, Gs_overrides=dict(dtype='float32', mapping_dtype='float32')),
    EasyDict(name='cond_zcrop',  func_name='metrics.conditional_number.CondN',     num_samples=50000, epsilon=1e-4, space='z', report_type='max', crop=True, minibatch_per_gpu=4, Gs_overrides=dict(dtype='float32', mapping_dtype='float32')),
    EasyDict(name='cond_wfull',  func_name='metrics.conditional_number.CondN',     num_samples=50000, epsilon=1e-4, space='w', report_type='mean', crop=False, minibatch_per_gpu=4, Gs_overrides=dict(dtype='float32', mapping_dtype='float32')),
    EasyDict(name='cond_zfull',  func_name='metrics.conditional_number.CondN',     num_samples=50000, epsilon=1e-4, space='z', report_type='mean', crop=False, minibatch_per_gpu=4, Gs_overrides=dict(dtype='float32', mapping_dtype='float32')),
]])
